...
def compendiumMenu(game):
    ...
    while True:
        ...
        text1 = fonts['1'].render("A Sword's Conquest", game.antialiasing, colors.yellow)
...
def settingsMenu(game):
    ...
    while True:
        ...
        text2 = fonts['1'].render("A Sword's Conquest", game.antialiasing, colors.orangeRed)
...
def main(game):
    ...
    while True:
        ...
        text2 = game.font1.render("A Sword's Conquest", game.antialiasing, colors.orangeRed)
        text3 = game.font1.render('Created by LGgameLAB', game.antialiasing, colors.orangeRed)
