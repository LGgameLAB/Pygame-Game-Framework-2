...
keySet = {'start': pygame.K_s,'retry':[pygame.K_r], 'toggleCam': pygame.K_c,'pRight': [pygame.K_RIGHT, pygame.K_d], 'pLeft': [pygame.K_LEFT, pygame.K_a], 'pUp': [pygame.K_UP, pygame.K_w], 'pDown':[pygame.K_UP, pygame.K_w],'fullScreen': pygame.K_f, 'pause': pygame.K_p}
